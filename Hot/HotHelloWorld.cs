...
namespace hot
{
    ...
    public static class HotHelloWorld
    {
        ...
        {
            UnityEngine.Debug.Log("Hot Start(HelloWorld world)");
        ...
        {
            UnityEngine.GUILayout.Label("这里是补丁里的逻辑处理！！！Update");
        ...
        {
            UnityEngine.Debug.Log("Hot TestX_1");
            __Hotfix_TestX_1.Invoke(world, name+"Update");
        }
        ...
        {
            UnityEngine.Debug.Log("Hot TestX_2");
        ...
        {
            UnityEngine.Debug.Log("Hot TestX_3");
            __Hotfix_TestX_3.Invoke(world, x, name + "Update");
        }
